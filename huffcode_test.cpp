...
void test_HuffCode_simple(Tester &t)
{
   ...
   retval = h.encode(text);
   correct = cwd[0] + cwd[0] + cwd[0] + cwd[1] + cwd[0] + cwd[2] + cwd[1] + cwd[0] + cwd[1] + cwd[1] + cwd[1] + cwd[2] + cwd[2] + cwd[0] + cwd[2] + cwd[1] + cwd[2] + cwd[2];
   result = (retval == correct);
   ...
   // Decode longer text
   text = cwd[0] + cwd[1] + cwd[2] + cwd[0] + cwd[2] + cwd[1] + cwd[1] + cwd[0] + cwd[2] + cwd[1] + cwd[2] + cwd[0] + cwd[2] + cwd[0] + cwd[1] + cwd[2] + cwd[1] + cwd[0] + cwd[0] + cwd[0] + cwd[0] + cwd[1] + cwd[1] + cwd[1] + cwd[2] + cwd[2] + cwd[2];
   retval = h.decode(text);
...
void test_HuffCode_complex(Tester &t)
{
   ...
   retval = h.encode(text);
   correct = cwd[0] + cwd[9] + cwd[0] + cwd[1] + cwd[2] + cwd[5] + cwd[5] + cwd[7] + cwd[2] + cwd[3] + cwd[8] + cwd[7] + cwd[6] + cwd[9] + cwd[8] + cwd[7] + cwd[6] + cwd[5] + cwd[4] + cwd[3] + cwd[2] + cwd[1] + cwd[0];
   result = (retval == correct);
   t.test(result, "encode longer text");
   ...
   // Decode longer text
   text = cwd[6] + cwd[9] + cwd[0] + cwd[8] + cwd[9] + cwd[9] + cwd[3] + cwd[3] + cwd[3] + cwd[4] + cwd[8] + cwd[9] + cwd[2] + cwd[6] + cwd[1] + cwd[7] + cwd[4] + cwd[0] + cwd[5] + cwd[1] + cwd[5] + cwd[0] + cwd[2] + cwd[8] + cwd[8] + cwd[8];
   retval = h.decode(text);
